...
import org.eclipse.edc.spi.monitor.Monitor; // Importa la interfaz Monitor
...
/**
 * This class provides a custom data plane extension for proxying requests.
 * It configures a public API endpoint and registers a proxy controller.
 */
